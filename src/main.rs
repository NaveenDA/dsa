...
fn main() {
    ...
    let input: Vec<String> = vec![String::from("eat"),String::from("tea"),String::from("12tan"),String::from("ate"),String::from("nat from the world"),String::from("hello!f#2"),String::from("#2")];
